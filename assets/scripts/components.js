      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav me-auto">
          ...
          <li class="nav-item dropdown d-none d-lg-block d-xxl-none">
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                <a class="dropdown-item" href="https://www.facebook.com/groups/4900129550052576" target="_blank">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item d-none d-xxl-block" id="nav-item-facebook">
            <a class="nav-link" href="https://www.facebook.com/groups/4900129550052576" target="_blank">
              <img src="assets/images/fb_icon.png" class="fb" alt="Facebook" />
            </a>
          </li>
        </ul>
